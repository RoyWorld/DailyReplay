...
import com.replay.dragon.rest.content.ConfigContent;
...
import com.replay.dragon.rest.gui.com.Browser;
import com.replay.dragon.rest.gui.com.Components;
import com.replay.dragon.rest.gui.http.EmbedHttpServer;
import com.replay.dragon.rest.gui.http.controller.ApiController;
import com.replay.dragon.rest.gui.util.ConfigUtil;
import com.replay.dragon.rest.gui.util.I18nUtil;
import com.replay.dragon.rest.gui.util.PathUtil;
...
//    PDownConfigContent.getInstance().load();
  ...
  private void initRest() {
    ...
    new SpringApplicationBuilder(ReplayServer.class).headless(false).build().run();
  }
...
//      embedHttpServer.addController(new PacController());
  ...
  private void initTray() throws AWTException {
    if (SystemTray.isSupported()) {
      ...
      trayIcon = new TrayIcon(trayImage, "Daily Replay");
