...
//import org.pdown.rest.boot.HttpDownBootstrap;
//import org.pdown.rest.dispatch.HttpDownCallback;
//import org.pdown.rest.util.OsUtil;
//import org.pdown.gui.StartApplication;
...
//    if (localeChange) {
//      StartApplication.INSTANCE.loadPopupMenu();
//    }
//    //检查到前置代理有变动重启MITM代理服务器
//    if (proxyChange && PDownProxyServer.isStart) {
//      new Thread(() -> {
//        PDownProxyServer.close();
//        PDownProxyServer.start(StartApplication.INSTANCE.PROXY_PORT);
//      }).start();
//    }
//    PDownConfigContent.getInstance().save();
