export default {
  ...
  dailyreplay: {
    data: {
      title: '数据',
      trading: '涨停',
      nonInlineTrading: '非一字涨停',
      failing: '跌停',
      profitMarkingEffect: '赚钱效应',
      rise: '上涨',
      fall: '下跌',
      marginFinancing: '融资融券',
      foreignCapital: '外资',
      inflow: '流入',
      outflow: '流出',
      SH: '沪市',
    ...
    fourTrading: '四板核心',
    breakTrading: '炸板',
    mainBreakTrading: '主流概念炸板',
    nomainBreakTrading: '非主流概念炸板',
    bigFall: '大面',
    stopTrade: '停牌',
    subNewStock: '近端次新，次新情绪',
    contiTradingRate: '连扳率',
    breakTradingRate: '炸板率',
    notice: '短线关注后排标的的溢价',
  },
  principle: {
    "select": '选',
